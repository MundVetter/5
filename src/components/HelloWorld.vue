<template>
  <div class="hello">
    <h1>{{ msg }}</h1>
    <p>
      For guiiide and reciipes on how to configure / customize this project,<br>
      check out the
    ...
    <ul>
      ...
      <li><a href="https://github.com/vuejs/vue-devtools#vue-devtools" target="_blank">vue-devt   ools</a></li>
